...
summaryLong: Permanent-ish implement list under Workbench, ordered above Sandbox. GET/POST /api/implement. Completing an item archives it (?done=1). Seeded from the operator’s third-round feedback. Distinct slate/teal chrome, not the Overview structure board.
tags:
  - implement-queue
  - workbench
  - agents
...
Parent: [Workbench](/site/workbench). Third-round notes: [Round 3 thinking](/site/workbench-round3).
